...
std::istream& operator>>(std::istream& is, Airplane& ob)
{
    ...
    std::cout << "Введите сборы в аэропорту (от 5 до 100 ): ";
    ob.collections= number_input(is,5,100);
    std::cout << "Введите вместимость пассажиров (от 10 до 120 ): ";
    ob.passenger_capacity=number_input(is,10,120);
    std::cout << "Введите грузоподъемность (кг) (от 1000.0 до 10000 ): ";
    ob.cargo_capacity=double_input(is,1000.0,1000);
